**Tags:** $${ \color{purple}[Construction] \space { \color{black},} \space \color{green}[Application] \space { \color{black},} \color{olive}[Thermal Expansion] \space { \color{black},} \space { \color{salmon} \textbf{8/10}}}$$
